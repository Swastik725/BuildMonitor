...
export function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // On success, isAuthed flips to true in context — App.tsx re-renders into the dashboard.
    } catch {
      // error is already captured in context state and shown below; nothing else to do here
    }
  }
      ...
      >
        ...
        <div className="space-y-2.5 mb-5">
          <a
            ...
            className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 border border-border rounded-md text-sm font-medium text-foreground hover:bg-secondary transition-colors cursor-pointer"
          >
